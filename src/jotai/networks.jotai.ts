...
const toPng = (svgUrl: string, size = 96) =>
  `https://wsrv.nl/?url=${encodeURIComponent(svgUrl)}&output=png&w=${size}`

const blueskyOGA     = toPng('https://api.iconify.design/simple-icons:bluesky.svg?color=%232D6A2D')
const linktreeOGA    = toPng('https://api.iconify.design/simple-icons:linktree.svg?color=%232D6A2D')

const blueskyJustice  = toPng('https://api.iconify.design/simple-icons:bluesky.svg?color=%232A9D8F')
const linktreeJustice = toPng('https://api.iconify.design/simple-icons:linktree.svg?color=%232A9D8F')

// const blueskyRaizes  = toPng('https://api.iconify.design/simple-icons:bluesky.svg?color=%23E8A020')
const siteRaizes = toPng('https://api.iconify.design/mdi:web.svg?color=%23E8A020')
const linktreeRaizes = toPng('https://api.iconify.design/simple-icons:linktree.svg?color=%23E8A020')
